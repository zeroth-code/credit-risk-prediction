...
probabilities under temporal drift, keeps selection decisions off the test set, and connects
model evidence to a transparent business-cost policy. The result must remain honest about
modest discrimination, operational workload, selection bias, and missing protected
attributes.
...
7. Evaluate once on the untouched 2015 test data with bootstrap intervals, monthly temporal
   slices, SHAP associations, and subgroup reliability diagnostics.

## Result

On 283,026 test loans, ROC AUC is 0.662707 (95% CI 0.660260-0.665304), average precision is
0.241568 (95% CI 0.238800-0.244326), and Brier score is 0.121539 (95% CI
0.121380-0.121700). Log loss is 0.399637, KS is 0.236654, and expected calibration error is
0.011108. These figures show measurable ranking signal and usable probability evidence, but
only modest discrimination.

Under the stated base cost scenario, the frozen policy evaluates USD 3.624 billion of exposure
at USD 16.272 million, or USD 57,493.53 per 1,000 applications. The 27 sensitivity scenarios
...
decline. SHAP identifies annual income, lower FICO, recent inquiries, loan amount, and DTI as
the leading base-model associations. Subgroup diagnostics expose large income and
home-ownership selection-rate differences, while explicitly stopping short of a legal audit.
